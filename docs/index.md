...
:--|:----|:---------
|**12/13**|<ul><li>Orientation - and Summer Assignment Review and Independent learning<li>**Lab:** Lab Equipment and Lab Saftey</ul> | <ul><li>[Notes](./notes/notes_2016_week_09_12.md)<li>[What is Science - PDF](./pdfs/what_is_science.pdf)<li>[How to read an MSDS](./pdfs/howtoreadmsds.pdf)<li>[At the Bench](./pdfs/at_the_bench.pdf)</ul>|
|**19/(No class on 20th**)|<ul><li>**Lab:** Basic Pipetting Skills - Measurement/ DNA Extraction Lab</ul> | |
|**26-27** | <ul><li>Modern Biology - What is Bioinformatics? <li>**Quiz:** Lab Safety</ul>|(Online virtual class - From South African Bioinformatics Conference) 
...
|**10/  (No class on 11 - Yom Kippur)**|<ul><li>**Computer Lab:** Introduction to Lab Math with Python</ul>|
|**17/18 (No class - Sukkot)**| | |
|**24/25 (No class - Sukkot)**| | |
|**31/Nov 1**| <ul><li>**Computer Lab:** Cont'd Lab Math with Python<li>**Lab:** Lab Practical - Making Solutions<li>**Quiz:** Lab Math </ul>| |
...
|Date|Topic|Notes/Links|
:--|:----|:---------
|**7/8 (Virtual class)**| <ul><li>Philosophy of Science and the "Scientific Method"</ul>|  |
|**14/15 (Virtual class)** | <ul><li>**Virtual Lab**: Finding DNA Primers</ul>| |
|**21/22** | <ul><li>Manipulating DNA in the Lab<li>**Lab:** DNA Extraction </ul>| Class **will be in-session** on 21st; PT Conferences Parents will be able to make appointment from 6:30PM on)| 
...
|Date|Topic|Notes/Links|
:--|:----|:---------
|**5/6 (Virtual Class from EMBL-Australia)**|<ul><li>Ethics of DNA</ul>||
|**12/13 (Virtual Class from EMBL-Australia)**|<ul><li>Online Analysis of Sequencing Results and Intro to Bacterial Transformation</ul>||
|**19/20** |<ul><li>Genetic Engineering<li>**Lab:** Culture and care of Bacteria<li>Quiz: Mitochondrial DNA</ul>||
